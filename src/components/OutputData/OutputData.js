...
const OutputData = ({totalValueState, secondProperty, thirdProperty, fourthProperty, fifthProperty, firstConnectCost, secondConnectCost, thirdConnectCost, fourthConnectCost, fifthConnectCost, setPrintFormat}) => {
    return (
                <article className="tc br3 ba dark-gray b--black-10 mv4 w-100 w-50-m w-25-l mw9 center formbackground">
                    <div className="">
                        <div className="pt4 pb4">Anläggningens värde: {totalValueState} kr</div>
                        ...
                        {(secondProperty === true) ?
                          ...
                          : (null)}
                        <div>
                          <p onClick={() => setPrintFormat(1)} className="silver pb2 pointer grow">Tryck här för utskriftsformat</p>
                        </div>
                    </div>
                </article>
    );
